...
const items = ["Convert (Template-Locked)", "Creative Flow", "Jobs"];
  ...
  return (
    <aside className="w-72 min-h-screen bg-slate-950 text-white p-6 border-r border-slate-800">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold leading-tight mt-2">
          PowerPoint conversion made simple
        </h1>
      </div>
      ...
      <div className="mt-8 text-xs text-slate-400 leading-relaxed">
        Upload once, then let the engine extract structure, enforce rules, and
        render a polished deck.
      </div>
    </aside>
  );
}
